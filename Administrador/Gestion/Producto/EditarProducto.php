...
<body>
    ...
    <section class="centrarContenido">
        <div class="apariencia">
            <h1 class="inicioH1">Editar producto</h1>
            <p><a href="../menuGestion.php">Menú gestión</a><strong>/</strong><a href="../GestionProducto.php">Gestión producto</a><strong>/</strong><a href="EditarProducto.php">Editar producto</a></p>
            <br><br>
            <div class="formulario">
                <div>
                    ...
                    ?>
                    <form action="Editar.php" method="POST" id="formulario" autocomplete="off" enctype="multipart/form-data">
                        <label for="Nombre">Nombre: </label>
                        <input type="text" name="nombre" id="nombre" autofocus value="<?php echo $fila['Nombre']; ?>">
                        <br><br>
                        <label for="Tipo">Tipo: </label>
                        <input type="text" name="tipo" id="tipo" value="<?php echo $fila['Tipo']; ?>">
                        <br><br>
                        <label for="Precio">Precio: </label>
                        <input type="text" name="precio" id="precio" value="<?php echo $fila['Precio']; ?>">
                        <br><br>
                        <label for="Stock">Stock: </label>
                        <input type="text" name="stock" id="stock" value="<?php echo $fila['Stock']; ?>">
                        <br><br>
                        <label for="Imagen">Imagen: </label>
                        <input type="file" name="imagen" id= "imagen" value="<?php echo $fila['Imagen']; ?>">
                        <br><br>
                        <label for="Descripcion">Descripcion: </label>
                        <textarea name="descripcion" value="<?php echo $fila['Descripcion']; ?>"></textarea>
                        <br><br>
                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                        <input type="submit" value="Editar usuario" class="botonFormulario" name="boton">
                    </form>
                    <?php
                    }
                    ?>
